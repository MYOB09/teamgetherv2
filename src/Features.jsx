      ...
      <div className=" pt-4 grid md:grid-cols-4 w-full text-center">
        <div className="">
          ...
          <div className="text-start px-8">
            ...
            <div className="m-4   hover:bg-gray-100 hover:cursor-pointer p-2  rounded-xl">
              <div className=" text-xl text-sky-700 ">Surveys and Polls</div>
            ...
            <div className="m-4   hover:bg-gray-100 hover:cursor-pointer p-2  rounded-xl">
              <div className=" text-xl text-sky-700">Values and Goals</div>
              Communicates core values and goals, enhancing purpose and
              alignment.
            </div>
            <div className="m-4   hover:bg-gray-100 hover:cursor-pointer p-2 ">
              <div className=" text-xl text-sky-700">Badges and Awards</div>
              Recognizes achievements with virtual awards, promoting
              appreciation and motivation.
            </div>
            <div className="m-4   hover:bg-gray-100 hover:cursor-pointer p-2 ">
              <div className=" text-xl text-sky-700">Events</div>
              Provides an event calendar to keep employees informed and engaged.
            </div>
            <div className="m-4   hover:bg-gray-100 hover:cursor-pointer p-2 ">
              <div className=" text-xl text-sky-700">Employee Recognition</div>
              Establishes a platform for peer recognition, strengthening team
              morale.
            </div>
            <div className="m-4   hover:bg-gray-100 hover:cursor-pointer p-2 ">
              <div className=" text-xl text-sky-700">Your Voice</div>
              Offers a confidential channel for feedback, promoting openness and
              action.
            </div>
            <div className="m-4   hover:bg-gray-100 hover:cursor-pointer p-2 ">
              <div className=" text-xl text-sky-700">Organizational Chart</div>
        ...
        <div>
          ...
          <div className="text-start px-8">
            <div className="hover:bg-gray-100 hover:cursor-pointer p-2 m-4  rounded-xl">
              <div className=" text-xl text-sky-700 ">360 Evaluation</div>
              Enables comprehensive performance appraisals, fostering employee
              development.
            </div>
            <div className="hover:bg-gray-100 hover:cursor-pointer p-2 m-4  rounded-xl">
              <div className=" text-xl text-sky-700 ">Performance Feedback</div>
              Fosters community by sharing experiences and insights across the
              organization.
            </div>
            <div className="hover:bg-gray-100 hover:cursor-pointer p-2 m-4  rounded-xl">
