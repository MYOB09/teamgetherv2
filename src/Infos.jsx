      ...
      <div className="flex flex-col m-12">
        <div className="m-4  text-center bg-sky-200 rounded-xl">
          ...
          <div className="p-2">
            ...
            organizational success, we have developed a platform that integrates
            seamlessly into a variety of industries, offering tailored solutions
        ...
        <div className="grid lg:grid-cols-4 ">
          <div className="m-4 p-2 text-center bg-gray-200 rounded-xl">
            ...
            <div className="">
              ...
              our platform offers features that help streamline communication,
              foster team integration, and enhance overall efficiency. From
              performance feedback systems and talent management groups to
              digital collaboration spaces and detailed analytics, we provide
              everything your organization needs to build a motivated, cohesive,
          ...
          <div className="m-4 p-2 text-center bg-gray-200 rounded-xl">
            ...
            <div>
              We envision a world where every employee feels valued, every voice
              is heard, and every team is aligned with their organization’s
              goals. Our platform is designed to create an environment where
              collaboration thrives, innovation is encouraged, and achievements
              are recognized.
            </div>
          </div>
          ...
          <div className="m-4 p-2 text-center bg-gray-200 rounded-xl">
            ...
            <div className="">
              ...
              Teamgether meets their specific needs, helping them overcome
              industry-specific challenges and achieve their unique business
              objectives. Our commitment to excellence means that we are
              constantly updating and refining our platform to incorporate the
              latest trends in employee engagement and management.
            </div>
          </div>
          <div className="m-4 p-2 text-center bg-gray-200 rounded-xl">
            <div className="text-4xl p-4">Our Commitment</div>
            <div>
              We are more than just a software provider; we are your partners in
              building a better workplace. Our team of experts is always
              available to provide support, offer insights, and help you get the
              most out of our platform. We are driven by our passion for helping
              businesses grow by unlocking the full potential of their teams.
            </div>
          </div>
        </div>
